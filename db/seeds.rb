...
Product.create({supplier_id: 2, name: "Angel Olsen - Little Mirrors", price: "17.75", description: "The breathtaking songs of Angel Olsen’s fifth album are fleshed out by a 12-piece string section and deliver grand gestures about romance, authenticity, and being simply at the mercy of how we feel.", inventory: 2})
Product.create({supplier_id: 1, name: "Rolling Stones - Some Girls", price: "12.5", description: "Some Girls is the 14th British and 16th American studio album by the English rock band the Rolling Stones, released on 9 June 1978 on Rolling Stones Records. It was the first album to feature guitarist Ronnie Wood as a full-time member; joining founder members Mick Jagger, Keith Richards, Bill Wyman and Charlie Watts.", inventory: 1})
Product.create({supplier_id: 3, name: "Paul Simon - S/T Reissue", price: "18.10", description: "Paul Simon's self-titled album belongs in everyones record collection. Easy to listen to and really showcases his abilities.", inventory: 1})
Product.create({supplier_id: 3, name: "Gladstone Anderson & Lynn Taitt & The Jets - Glad Sounds", price: "21.0", description: "Rocksteady compilation", inventory: 1})
Product.create({supplier_id: 2, name: "Husker Du - Zen Arcade", price: "14.25", description: "Zen Arcade is the second studio album by American punk rock band Hüsker Dü, released in July 1984 on SST Records. Originally released as a double album on two vinyl LPs, Zen Arcade tells the story of a young boy who runs away from an unfulfilling home life, only to find the world outside is even worse.", inventory: 2})
Product.create({supplier_id: 1, name: "Helena Deland - Altogether Unaccompanied", price: "9.99", description: "Deland shows her stripes on this EP. “Perfect Weather For A Crime” is mischievous, a clever balance between a “Like A Virgin” bass line and a pre-Masseduction St. Vincent.", inventory: 1})
Product.create({supplier_id: 1, name: "Modest Mouse - The Moon & Antarctica", price: "40.00", description: "The Moon & Antarctica is the third studio album by American rock band Modest Mouse, released on June 13, 2000 by Epic Records. The album's title is taken from the opening scene of the 1982 film Blade Runner, where the main character reads a newspaper headlined 'Farming the Oceans, the Moon and Antarctica.'", inventory: 1})
